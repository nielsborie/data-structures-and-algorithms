...
if __name__ == "__main__":
    ...
    def has_a_path_dfs(graph: Graph, source_id: str, destination_id: str) -> None:
        print(
            f"[DFS] Is a path between {source_id} and {destination_id} exists ? : {graph.search_by_dfs(source_id, destination_id)}")


    def has_a_path_bfs(graph: Graph, source_id: str, destination_id: str) -> None:
        print(
            f"[BFS] Is a path between {source_id} and {destination_id} exists ? : {graph.search_by_bfs(source_id, destination_id)}")
